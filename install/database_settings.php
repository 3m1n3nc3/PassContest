...
################################################################################
	...
	if($task == 'send'){
		...
		$site_email			= isset($_POST['site_email']) ? prepare_input($_POST['site_email']) : '';
		$site_owner			= isset($_POST['site_owner']) ? prepare_input($_POST['site_owner']) : '';
		$site_owner_url		= isset($_POST['site_owner_url']) ? prepare_input($_POST['site_owner_url']) : ''; 
		...
		if($database_host == ''){
			...
			$focus_field = 'site_email';
			$error_msg = lang_key('alert_site_email_empty');
		}else if($site_owner == ''){
			$focus_field = 'site_owner';
			$error_msg = lang_key('alert_site_owner_empty');		
		}else if($site_owner_url == ''){
			$focus_field = 'site_owner_url';
			$error_msg = lang_key('alert_site_owner_url_empty');
		}else{
			...
			if(empty($error_msg)){
				...
				$_SESSION['site_owner'] = $site_owner;
				$_SESSION['site_owner_url'] = $site_owner_url;
		...
		$site_owner			= isset($_SESSION['site_owner']) ? $_SESSION['site_owner'] : '';
		$site_owner_url		= isset($_SESSION['site_owner_url']) ? $_SESSION['site_owner_url'] : '';
...
<head>
    ...
    <meta name="author" content="Newnify Music Limited">
    <meta name="generator" content="Newnify Whatafolio Installer">
	<title><?php echo lang_key("installation_guide"); ?> | <?php echo lang_key('database_settings'); ?></title>

	<link href="https://newnify.com/favicon.png" rel="shortcut icon" />
...
<div id="main">
	...
	<div id="content">
		...
		<div class="central-part">
			...
			<tr>
				<td width="200px" nowrap>&nbsp;<?php echo lang_key('database_host'); ?>: <span class="star">*</span></td>
				<td>
					<input type="text" class="form_text" name="database_host" id="database_host" size="30" value="<?php echo $database_host; ?>" placeholder="<?php if(EI_MODE == 'demo') {echo 'demo: localhost';} else{ echo "localhost";} ?>" onfocus="textboxOnFocus('notes_host')" onblur="textboxOnBlur('notes_host')" />					
				</td>
				<td rowspan="7" valign="top">										
					...
					<div id="notes_email" class="notes_container">
						<h4><?php echo lang_key('site_email'); ?></h4>
						<p><?php echo lang_key('site_email_info'); ?></p>
					</div>
					<div id="notes_site_owner" class="notes_container">
						<h4><?php echo lang_key('site_owner'); ?></h4>
						<p><?php echo lang_key('site_owner_info'); ?></p>
					</div>	
					<div id="notes_site_owner_url" class="notes_container">
						<h4><?php echo lang_key('site_owner_url'); ?></h4>
						<p><?php echo lang_key('site_owner_url_info'); ?></p>
					</div>						
			...
			<tr>
				...
				<td>
					<input type="text" class="form_text" name="database_prefix" size="12" maxlength="12" value="<?php echo $database_prefix; ?>" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="prefix_" onfocus="textboxOnFocus('notes_db_prefix')" onblur="textboxOnBlur('notes_db_prefix')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('database_username'); ?>: <span class="star">*</span></td>
				<td>
					<input type="text" class="form_text" name="database_username" id="database_username" size="30" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> value="<?php echo $database_username; ?>" placeholder="<?php if(EI_MODE == 'demo') {echo 'demo: test';} else{ echo "database_user";} ?>" onfocus="textboxOnFocus('notes_db_user')" onblur="textboxOnBlur('notes_db_user')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('database_password'); ?>:</td>
				<td>
					<input type="password" class="form_text" name="database_password" id="database_password" size="30" value="<?php echo $database_password; ?>" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="<?php if(EI_MODE == 'demo') {echo 'demo: test';} else{ echo "database_password";} ?>" onfocus="textboxOnFocus('notes_db_password')" onblur="textboxOnBlur('notes_db_password')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('database_name'); ?>: <span class="star">*</span></td>
				<td>
					<input type="text" class="form_text" name="database_name" id="database_name" size="30" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> value="<?php echo $database_name; ?>" placeholder="<?php if(EI_MODE == 'demo') {echo 'demo: db_name';} else{ echo "database_name";} ?>" onfocus="textboxOnFocus('notes_db_name')" onblur="textboxOnBlur('notes_db_name')" />					
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('site_email'); ?>: <span class="star">*</span></td>
				<td>
					<input type="text" class="form_text" name="site_email" id="site_email" size="30" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> value="<?php echo $site_email; ?>" placeholder="<?php if(EI_MODE == 'demo'){ echo 'demo: site_email';} else{ echo "support@passcontest.com";} ?>" onfocus="textboxOnFocus('notes_email')" onblur="textboxOnBlur('notes_email')" />					
				</td>
			</tr> 
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('site_owner'); ?>: <span class="star">*</span></td>
				<td>
					<input type="text" class="form_text" name="site_owner" id="site_owner" size="30" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> value="<?php echo $site_owner; ?>" placeholder="<?php if(EI_MODE == 'demo') {echo 'demo: site_owner';} else{ echo "Passcontest";} ?>" onfocus="textboxOnFocus('notes_site_owner')" onblur="textboxOnBlur('notes_site_owner')" />					
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('site_owner_url'); ?>: <span class="star">*</span></td>
				<td>
					<input type="text" class="form_text" name="site_owner_url" id="site_owner_url" size="30" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> value="<?php echo $site_owner_url; ?>" placeholder="<?php if(EI_MODE == 'demo') {echo 'demo: site_owner_url';} else{ echo "https://passcontest.com";} ?>" onfocus="textboxOnFocus('notes_site_owner_url')" onblur="textboxOnBlur('notes_site_owner_url')" />					
				</td>
			</tr>
			<tr>
