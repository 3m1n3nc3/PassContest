...
ALTER TABLE <DB_PREFIX>users ADD online int(11) NOT NULL;
ALTER TABLE <DB_PREFIX>users ADD gender varchar(128) NULL DEFAULT NULL AFTER `lname`,

-- Alter the settings TABLE
ALTER TABLE <DB_PREFIX>settings ADD email_reply_temp text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL;
ALTER TABLE <DB_PREFIX>settings ADD online_time int(11) NOT NULL DEFAULT '600';
ALTER TABLE <DB_PREFIX>settings ADD per_messenger int(11) NOT NULL DEFAULT '5';
ALTER TABLE <DB_PREFIX>settings ADD email_social enum('0','1') NOT NULL DEFAULT '1';
ALTER TABLE <DB_PREFIX>settings ADD twilio_sid varchar(128) DEFAULT NULL;
ALTER TABLE <DB_PREFIX>settings ADD twilio_token varchar(128) DEFAULT NULL;
ALTER TABLE <DB_PREFIX>settings ADD twilio_phone varchar(128) DEFAULT NULL;
ALTER TABLE <DB_PREFIX>settings ADD site_phone varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;
ALTER TABLE <DB_PREFIX>settings ADD ads_6 text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL;
ALTER TABLE <DB_PREFIX>settings ADD skin varchar(128) NOT NULL DEFAULT 'mdb-skin';
ALTER TABLE <DB_PREFIX>settings ADD landing enum('1','2') NOT NULL DEFAULT '1';
ALTER TABLE <DB_PREFIX>settings ADD sms enum('0','1') NOT NULL DEFAULT '0';
ALTER TABLE <DB_PREFIX>settings ADD sms_premium enum('0','1') NOT NULL DEFAULT '1';

-- Alter the comment TABLE
ALTER TABLE <DB_PREFIX>comments ADD master enum('post','gallery','poll','') NOT NULL DEFAULT 'post';

-- Alter the contest TABLE
ALTER TABLE <DB_PREFIX>contest ADD cid int(11) NOT NULL;
ALTER TABLE <DB_PREFIX>contest ADD tags varchar(255) DEFAULT NULL;
ALTER TABLE <DB_PREFIX>contest ADD allow_free enum('0','1') NOT NULL DEFAULT '1'; 
...
-- Update admin TABLE
UPDATE `<DB_PREFIX>admin` SET `id` = 1, `username` = '<USER_NAME>', `password` = '<PASSWORD>';
...
CREATE TABLE IF NOT EXISTS `<DB_PREFIX>timelines` (
...
CREATE TABLE IF NOT EXISTS `<DB_PREFIX>relationships` (
...
CREATE TABLE IF NOT EXISTS `<DB_PREFIX>blocked_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `by` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `<DB_PREFIX>welcome` (
  `carousel_one` text,
...
INSERT INTO `<DB_PREFIX>api` (`id`, `token`, `server`) VALUES
