	...
	<div id="content">
		...
		<div class="central-part">
			...
			<tr>
				...
				<td><input name="admin_username" id="admin_username" class="form_text" size="28" maxlength="22" value="<?php echo $admin_username; ?>" onfocus="textboxOnFocus('notes_admin_username')" onblur="textboxOnBlur('notes_admin_username')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="<?php if(EI_MODE == 'demo') {echo 'demo: test';} else{ echo "admin";} ?>" /></td>
			...
			<tr>
				...
				<td><input name="admin_password" id="admin_password" class="form_text" type="password" size="28" maxlength="22" value="<?php echo $admin_password; ?>" onfocus="textboxOnFocus('notes_admin_password')" onblur="textboxOnBlur('notes_admin_password')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="<?php if(EI_MODE == 'demo') {echo 'demo: test';} else{ echo "password";} ?>" /></td>
			</tr> 
				...
				<tr>
					...
					<td>
						...
						<option <?php echo (($password_encryption == 'AES') ? 'selected="selected"' : ''); ?> value="AES" disabled>AES</option>
						</select>
					</td>
				</tr>							
				<?php } ?>
