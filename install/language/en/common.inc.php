...
$arrLang['licence_screen'] = "Licence Activation Screen";
$arrLang['validated_successfully'] = "Key Successfully Validated...";
...
$arrLang['alert_http_server_empty'] = "HTTP SERVER cannot be empty! Please re-enter.";
$arrLang['alert_site_owner_empty'] = "Site Owner cannot be empty! Please re-enter.";
$arrLang['alert_site_owner_url_empty'] = "Site Owner URL cannot be empty! Please re-enter.";

$arrLang['alert_site_email_empty'] = "SITE EMAIL cannot be empty! Please re-enter.";
$arrLang['alert_site_dir_empty'] = "Site Root Directory cannot be empty! Please re-enter.";
...
$arrLang['alert_site_name_empty'] = "Site Name cannot be empty! Please re-enter.";
...
$arrLang['admin_email_info'] = "Admin Email that will be replaced in SQL dump with email placeholder (if defined). It will also enable email delivery from contact form and subscription form to your email and mailchimp address.";
$arrLang['mc_api'] = "Mail Chimp API";
$arrLang['mc_api_info'] = "Save addresses to mailchimp mailing list, you can get you api key from your 
	mailchimp, Get one here <a href='http://admin.mailchimp.com/account/api/'>http://admin.mailchimp.com/account/api</a>";
$arrLang['mc_listid'] = "Mail Chimp List ID";
$arrLang['mc_listid_info'] = "Enter your Mail Chimp list's unique ID, Create a list here <a href='http://admin.mailchimp.com/
	lists/'>http://admin.mailchimp.com/lists</a>";
...
$arrLang['site_email'] = "Site Email Address";
$arrLang['site_email_info'] = "The Email address from which all Emails from this site will be sent from";
$arrLang['site_owner'] = "Site Owner";
$arrLang['site_owner_info'] = "The copyright owner of this website, shown on the footer";
$arrLang['site_owner_url'] = "Site Owner URL";
$arrLang['site_owner_url_info'] = "The URL of the copyright owner of this website, shown on the footer";


$arrLang['site_dir'] = "Root Directory";
$arrLang['site_dir_info'] = "For most hosts the root directory for your primary domain is the 'public_html' folder. For addon domains (separate websites) it would be 'public_html/newnify.com' and for subdomains (like whatafolio.newnify.com) it would be 'public_html/whatafolio'. for some host you might be looking for something that looks like: /home/cpanelusername/public_html/currentsite. If you are on a local server it will look like 'C:/wamp64/www/whatafolio' ";
...
$arrLang['site_name'] = "Site Name";
$arrLang['site_name_info'] = "The title of your website E.g. whataportal";
...
$arrLang['follow_the_wizard'] = "Follow the <b>Wizard</b> to install Passcontest";
