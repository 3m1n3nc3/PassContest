...
$arrLang['alert_http_server_empty'] = "HTTP SERVER darf nicht leer sein! Bitte erneut eingeben.";
$arrLang['alert_site_dir_empty'] = "Das Site Root Verzeichnis darf nicht leer sein! Bitte erneut eingeben.";
...
$arrLang['mc_api_info'] = "Adressen in Mailchimp Mailingliste speichern, Sie können einen API Schlüssel von Ihrem bekommen mailchimp, Holen Sie sich hier <a href='http://admin.mailchimp.com/account/api/'> http://admin.mailchimp.com/account api </a> ";
$arrLang['mc_listid'] = "Mail Chimp List ID";
$arrLang['mc_listid_info'] = "Geben Sie die eindeutige ID Ihrer Mail-Chimp-Liste ein, erstellen Sie hier eine Liste <a href ='http://admin.mailchimp.com/lists/'> http://admin.mailchimp.com/lists </a> ";
...
$arrLang['http_server_info'] = "Die Basis-URL Ihrer Website mit Ausnahme des Protokolls (z. B. www.newnify.com oder www.newnify.com/whatafolio oder whataportal.newnify.com oder localhost/whatafolio";
$arrLang['site_dir'] = "Stammverzeichnis";
$arrLang['site_dir_info'] = "Für die meisten Hosts ist das Stammverzeichnis für Ihre primäre Domain der 'public_html' Ordner. Für Addon Domains (separate Websites) wäre es 'public_html/newnify.com' und für Subdomains (wie whatafolio.newnify.com) es wäre 'public_html/whatafolio' Für einen Host suchen Sie vielleicht nach etwas, das wie folgt aussieht: /home/cpanelusername/public_html/ streetsite Wenn Sie auf einem lokalen Server sind, sieht es aus wie 'C:/ wamp64/www/whatafolio' ";
